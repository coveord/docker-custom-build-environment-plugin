    ...
    public void run_inside_pulled_container() throws Exception {
        ...
        project.getBuildWrappersList().add(
            new DockerBuildWrapper(
                ...
                "", new DockerServerEndpoint("", ""), "", true, false, Collections.<Volume>emptyList(), false, "root", "root", "cat", false, "bridge", null, null)
        );
    ...
    public void run_inside_built_container() throws Exception {
        ...
        project.getBuildWrappersList().add(
                new DockerBuildWrapper(
                        ...
                        "", new DockerServerEndpoint("", ""), "", true, false, Collections.<Volume>emptyList(), false, "jenkins", "jenkins", "cat", false, "bridge", null, null)
        );
        project.getBuildersList().add(new Shell("lsb_release  -a"));
